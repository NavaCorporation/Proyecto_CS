namespace ProyectoCS_CVista
{
    partial class FrmCliente
    {
        ...
        private void InitializeComponent()
        {
            ...
            panelBProveedor.Controls.Add(lbCrearCliente);
            ...
            panelBProveedor.Location = new Point(-1, 0);
            panelBProveedor.Margin = new Padding(0);
            panelBProveedor.Name = "panelBProveedor";
            panelBProveedor.Size = new Size(1004, 624);
            ...
            lbCrearCliente.Controls.Add(txtContraUser);
            lbCrearCliente.Controls.Add(txtCorreoUser);
            lbCrearCliente.Controls.Add(txtDireUser);
            lbCrearCliente.Controls.Add(txtNombreUser);
            lbCrearCliente.Controls.Add(lbCorreoUser);
            lbCrearCliente.Controls.Add(lbTeleUser);
            lbCrearCliente.Controls.Add(lbDireUser);
            lbCrearCliente.Controls.Add(lbPassUser);
            ...
            lbCrearCliente.ResumeLayout(false);
            lbCrearCliente.PerformLayout();
        ...
        private Panel lbCrearCliente;
        private Label lbTeleUser;
        private Label lbDireUser;
        private Label lbPassUser;
        ...
        private Label lbPro;
        private Label lbCorreoUser;
        private TextBox txtTeleUser;
        private TextBox txtContraUser;
        private TextBox txtCorreoUser;
        private TextBox txtDireUser;
        private TextBox txtNombreUser;
        private Button btnLimpUser;
